...
function FahrenheitCentigrados () 
{
	...
	document.getElementById('txtIdTemperatura').value= temperaturaFahrenheit+
	 "° Fahrenheit son "+temperaturaCentigrados.toFixed(2)+ "° Centígrados.";
...
function CentigradosFahrenheit () 
{
	...
	document.getElementById('txtIdTemperatura').value= temperaturaCentigrados+
	 "° Centígrados son "+ temperaturaFahrenheit.toFixed(2)+ "° Fahrenheit.";
